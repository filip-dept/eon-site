...
/* cubic-bezier(0.7, 0, 0.3, 1) — symmetric ease-in-out for the intro lift +
   the coupled hero rise (the "zoox" glide-into-place) */
CustomEase.create('eonGlide', 'M0,0 C0.7,0 0.3,1 1,1');
